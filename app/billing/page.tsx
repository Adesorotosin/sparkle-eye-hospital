...
export default function BillingCheckoutView() {
  ...
  const handleLogout = () => {
    ...
    cookiesToClear.forEach((name) => {
      ...
      document.cookie = `${name}=; path=/billing; expires=Thu, 01 Jan 1970 00:00:00 UTC; SameSite=Lax;`;
      document.cookie = `${name}=; path=/cashier; expires=Thu, 01 Jan 1970 00:00:00 UTC; SameSite=Lax;`;
    });
            ...
            <div className="space-y-5">
              ...
              <div className="space-y-3">
                <button
                  ...
                  className="w-full p-3.5 bg-white border border-slate-300 hover:border-[#5E35B1] hover:bg-purple-50/50 text-slate-800 rounded-xl text-xs font-bold transition flex items-center justify-between group shadow-2xs cursor-pointer"
                >
                  <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  className="w-full p-3.5 bg-[#5E35B1] hover:bg-[#4527A0] text-white rounded-xl text-xs font-bold transition flex items-center justify-between shadow-xs group cursor-pointer"
                >
                  <div className="flex items-center gap-3">
