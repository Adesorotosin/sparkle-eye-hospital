...
export default function ExecutiveOverviewDashboard() {
  ...
  return (
    <div className="min-h-screen bg-[#F4F6FB] p-8 text-slate-800 font-sans antialiased selection:bg-purple-100 selection:text-purple-900">
      {/* TOP HEADER */}
      <header className="flex flex-wrap items-center justify-between gap-4 mb-8">
        <div>
          ...
          <p className="text-xs text-slate-500 font-medium mt-0.5">
            VisionFirst Eye Hospital &mdash; Management Portal
          </p>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative">
            <select
              ...
              className="appearance-none bg-white border border-slate-200 rounded-xl px-3.5 py-2 pr-8 text-xs font-bold text-slate-700 hover:bg-slate-50 transition cursor-pointer focus:outline-none shadow-2xs"
            >
          ...
          {/* Export Button */}
          <button className="bg-white border border-slate-200 hover:bg-slate-50 text-slate-700 font-bold px-4 py-2 rounded-xl text-xs transition flex items-center gap-2 shadow-2xs">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-white rounded-2xl border border-slate-200/80 p-5 shadow-xs relative overflow-hidden border-l-4 border-l-purple-600">
          ...
          <div>
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <div className="w-full h-2.5 bg-slate-100 rounded-full overflow-hidden">
                  <div className="h-full bg-purple-500 rounded-full w-[58%]"></div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="w-full h-2.5 bg-slate-100 rounded-full overflow-hidden">
                  <div className="h-full bg-purple-400 rounded-full w-[38%]"></div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="w-full h-2.5 bg-slate-100 rounded-full overflow-hidden">
                  <div className="h-full bg-purple-300 rounded-full w-[22%]"></div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="lg:col-span-6 bg-white rounded-2xl border border-slate-200/80 p-6 shadow-xs">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              <div className="flex-1 h-2 bg-slate-100 rounded-full overflow-hidden">
                <div className="h-full bg-purple-400 rounded-full w-[50%]"></div>
              </div>
              <span className="text-xs font-extrabold text-slate-800 text-right min-w-[70px]">
                87 referrals
              </span>
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              <div className="flex-1 h-2 bg-slate-100 rounded-full overflow-hidden">
                <div className="h-full bg-purple-300 rounded-full w-[38%]"></div>
              </div>
              <span className="text-xs font-extrabold text-slate-800 text-right min-w-[70px]">
                63 referrals
              </span>
